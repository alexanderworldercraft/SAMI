  ...
  const renderSmallCard = (item, className = "") => {
    ...
    return (
      <a
        ...
        className={`group relative min-h-[116px] overflow-hidden rounded-xl border border-white/15 bg-slate-950 transition duration-300 hover:-translate-y-1 hover:border-sky-300/70 ${className}`}
      >
        <img
  ...
  const renderFeaturedCard = () => {
    ...
    return (
      <a
        ...
        className="group relative min-h-[260px] overflow-hidden rounded-xl border border-sky-200/40 bg-slate-950 shadow-2xl shadow-sky-950/40 transition duration-300 hover:-translate-y-1 hover:border-sky-300/80 xl:col-start-2 xl:row-span-2"
      >
        <img
        ...
        <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-[minmax(150px,1fr)_minmax(280px,1.75fr)_minmax(150px,1fr)_minmax(145px,0.95fr)] xl:grid-rows-2">
          ...
          {standardVideos[4] ? (
            <a
              ...
              className="group relative overflow-hidden rounded-xl border border-white/15 bg-slate-950 transition duration-300 hover:-translate-y-1 hover:border-sky-300/70 sm:col-span-2 xl:col-start-4 xl:row-span-2 xl:col-span-1"
            >
              <img
